...
const DEPRECATED_PACKAGES = ['@hai3/uikit-contracts', '@hai3/uicore'];
...
function testLayeredConfigsExist(): TestResult[] {
  ...
  // Depcruise config package
  const depcruiseConfigPath = join(process.cwd(), 'packages', 'depcruise-config');
